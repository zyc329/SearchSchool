<template>
  <a-modal :title="title" :width="width" :visible="visible" :destroyOnClose="true" :closable="false">
    <a-row>
        ...
        <a-form :form="form1" :label-col="{ span: 8 }" :wrapper-col="{ span: 12 }">
          <a-form-item label="学校校标">
            <a-upload
              ...
              :customRequest="
                (data) => {
                  customRequest(data, 'schoolTitle', 1)
                }
              "
            >
              <a-button>
          ...
          <a-form-item label="学校详情页标题图片">
            <a-upload
              ...
              :customRequest="
                (data) => {
                  customRequest(data, 'schoolDetail', 2)
                }
              "
            >
              <a-button>
          ...
          <a-form-item label="学校照片墙">
            <a-upload
              ...
              :customRequest="
                (data) => {
                  customRequest(data, 'schoolPhoto', 3)
                }
              "
            >
              <a-button>
