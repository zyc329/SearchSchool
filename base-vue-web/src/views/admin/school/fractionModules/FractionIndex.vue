<template>
  <div class="TableList">
      ...
      <a-row>
        <a-col :span="8">
          <a-form-item label="学校名称">
            <a-input v-decorator="['schoolName']" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item label="学校类型">
            <a-select v-decorator="['schoolType']">
              <a-select-option value="0"> 专科 </a-select-option>
    ...
    <a-modal width="30%" title="专业选择" :visible="visible" :destroyOnClose="true" :closable="false">
      <div style="width: 100%; height: 200px;">
        <a-row>
          <a-col :span="6" style="text-align: right"> 专业选择： </a-col>
          <a-col :span="18">
    ...
    <a-modal width="60%" title="分数查询" :visible="scoreVisible" :destroyOnClose="true" :closable="false">
      <a-form :form="form1" :label-col="{ span: 5 }" :wrapper-col="{ span: 12 }">
        ...
        <a-spin :spinning="loading1">
          <a-table :columns="columns1" :data-source="tableData1" :pagination="pagination1" @change="handleTableChange1">
            <span slot="action" slot-scope="text, record">
