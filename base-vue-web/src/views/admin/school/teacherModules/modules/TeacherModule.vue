      ...
      <a-row>
        <a-col span="8">
          ...
          <a-upload
            ...
            :customRequest="(data)=>{customRequest(data,'profilePicture')}"
            :remove="handleRemove"
          >
            <img style="width: 240px;height: 300px;" v-if="imageUrl" :src="'/download?picId='+profilePicture"
                 alt="avatar"/>
            <div v-else>
        ...
        <a-col span="8">
          ...
          <a-form-item label="教师简历">
            <a-textarea
              ...
              v-decorator="['teacherIntroduction']"
            />
          </a-form-item>
        </a-col>
      </a-row>
  ...
  export default {
    ...
    methods: {
      ...
      getCollege() {
        ...
        collegeFindList({schoolId: this.form.getFieldValue('schoolId')}).then(res => {
          let college = []
          for (let item of res.data) {
      ...
      getProfessional() {
        ...
        professionalFindList({collegeId: this.form.getFieldValue('collegeId')}).then(res => {
          let professional = []
          for (let item of res.data) {
