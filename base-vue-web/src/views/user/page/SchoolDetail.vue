    ...
    <div class="mh w100 div-content">
      ...
      <div class="plr50 w100">
        <a-tabs default-active-key="1">
          ...
          <a-tab-pane key="2" tab="教师信息"> Content of Tab Pane 2 </a-tab-pane>
          <a-tab-pane key="3" tab="专业信息"> Content of Tab Pane 3 </a-tab-pane>
          <a-tab-pane key="4" tab="照片墙"> Content of Tab Pane 3 </a-tab-pane>
        </a-tabs>
      </div>
